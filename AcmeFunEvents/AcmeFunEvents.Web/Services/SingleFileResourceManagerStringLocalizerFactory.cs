...
namespace AcmeFunEvents.Web.Services
{
    public class SingleFileResourceManagerStringLocalizerFactory : IStringLocalizerFactory
    {
        ...
        private readonly ConcurrentDictionary<string, SingleFileResourceManagerStringLocalizer> _localizerCache = new ConcurrentDictionary<string, SingleFileResourceManagerStringLocalizer>();
